...
public class geneChart {
	...
	// chart pour nbr client ajouté par mois (chart type line)
	public JFreeChart nbrClientAjoutByMonth() throws ParseException {
		...
		JFreeChart chart = ChartFactory.createTimeSeriesChart("nbr client ajouté par mois", "année-mois", "nbr client",
				dataset, true, true, false);
		// personaliser l'affichage des dates pour l'axe X
	...
	public JFreeChart nbrEmpruntByClient() throws ParseException {
		...
		JFreeChart chart = ChartFactory.createBarChart("nbr emprunt par client mois courant", "clients", "nbr emprunt",
	...
	public JFreeChart getempruntR() throws ParseException {
		...
		JFreeChart chart = ChartFactory.createBarChart("emprunts avec et sans retard", "mois/année", "br emprunt ",
	...
	public JFreeChart nvEmpByMonth() throws ParseException {
		...
		JFreeChart chart = ChartFactory.createTimeSeriesChart("nbr Emprunt  par mois", "année-mois", "nbr emprunt",
				dataset, true, true, false);
	...
	public JFreeChart nvMatByMonth() throws ParseException {
		...
		JFreeChart chart = ChartFactory.createTimeSeriesChart("nbr nouveau materiel  par mois", "année-mois",
				"nV Materiel", dataset, true, true, false);
	...
	public JFreeChart etatMat() throws ParseException {
		...
		JFreeChart chart = ChartFactory.createPieChart("Etat Materiel", pieDataset, true, true, false);
	...
	public void writeChartToPDF(List<JFreeChart> charts, String fileName) throws ParseException {
		...
		try {
			...
			for (JFreeChart element : charts) {
				...
				Graphics2D graphics2d = pdfTemplate.createGraphics(widthh, heightt, new DefaultFontMapper());
